            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <p style="width:74%; position:relative; left: 22%">
                            Se le ofrecerá una contraseña generica una vez que se acepte su registro. Podrá cambiarla posteriormente. Se le enviará al correo indicado en el registro.</p>
                        </div>
                        <center>
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary">
                                    {{ __('Enviar petición de registro') }}
                                </button>
                            </div>
