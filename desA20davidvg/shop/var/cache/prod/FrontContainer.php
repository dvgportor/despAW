...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => 'bd', 'port' => '', 'dbname' => 'prestashop', 'user' => 'root', 'password' => 'abc123.', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/web/a20davidvg.kozow.com/public/shop/modules/ps_checkout/src/Entity']);
        $d->addExcludePaths([0 => '/web/a20davidvg.kozow.com/public/shop/modules/ps_checkout/src/Entity/index.php']);
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/web/a20davidvg.kozow.com/public/shop/modules/productcomments/src/Entity']);
        $e->addExcludePaths([0 => '/web/a20davidvg.kozow.com/public/shop/modules/productcomments/src/Entity/index.php']);

        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/web/a20davidvg.kozow.com/public/shop/src/PrestaShopBundle/Entity']), 'PrestaShop');
        ...
        $a->setProxyDir('/web/a20davidvg.kozow.com/public/shop/var/cache/prod//doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_3be65e52aaf0b3b20375ffe680a6a4effd7d3115bef52839897c651ab0e7e763');
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/web/a20davidvg.kozow.com/public/shop/var/cache/prod//localization');
    }
    ...
    {
        $this->services['prestashop.core.localization.cldr.datalayer.locale_cache'] = $instance = new \PrestaShop\PrestaShop\Core\Localization\CLDR\DataLayer\LocaleCache(${($_ = isset($this->services['prestashop.core.localization.cldr.cache.adapter']) ? $this->services['prestashop.core.localization.cldr.cache.adapter'] : ($this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/web/a20davidvg.kozow.com/public/shop/var/cache/prod//localization'))) && false ?: '_'});
    ...
    {
        return $this->services['ps_checkout.cache.directory'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('1.7.8.4', '/web/a20davidvg.kozow.com/public/shop', false);
    }
    ...
    {
        return $this->services['ps_checkout.logger.directory'] = new \PrestaShop\Module\PrestashopCheckout\Logger\LoggerDirectory('1.7.8.4', '/web/a20davidvg.kozow.com/public/shop');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.root_dir' => '/web/a20davidvg.kozow.com/public/shop/app',
            'kernel.project_dir' => '/web/a20davidvg.kozow.com/public/shop',
            'kernel.name' => 'app',
            'kernel.debug' => false,
            'kernel.environment' => 'prod',
            'kernel.cache_dir' => '/web/a20davidvg.kozow.com/public/shop/var/cache/prod/',
            ...
            'doctrine.orm.proxy_dir' => '/web/a20davidvg.kozow.com/public/shop/var/cache/prod//doctrine/orm/Proxies',
